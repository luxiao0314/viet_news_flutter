...
class ContentListResponse {
  ...
  factory ContentListResponse(jsonStr) => jsonStr == null
      ? null
      : jsonStr is String
          ? new ContentListResponse.fromJson(json.decode(jsonStr))
          : new ContentListResponse.fromJson(jsonStr);
  ...
  ContentListResponse.fromJson(jsonRes) {
    ...
    data = jsonRes['data'] == null
        ? null
        : new ContentListResponseData.fromJson(jsonRes['data']);
  }
...
class ContentListResponseData {
  ...
  ContentListResponseData.fromParams(
  ...
  ContentListResponseData.fromJson(jsonRes) {
    ...
    for (var listItem in list == null ? [] : jsonRes['list']) {
      list.add(listItem == null
          ? null
          : new ContentListResponseList.fromJson(listItem));
    }
  }
...
class ContentListResponseList {
  ...
  ContentListResponseList.fromParams(
      {this.image_array, this.author, this.content});
  ...
  ContentListResponseList.fromJson(jsonRes) {
    ...
    for (var image_arrayItem
      ...
      image_array.add(image_arrayItem == null
          ? null
          : new ContentListResponseImages.fromJson(image_arrayItem));
    }

    author = jsonRes['author'] == null
        ? null
        : new ContentListResponseAuthor.fromJson(jsonRes['author']);
    content = jsonRes['content'] == null
        ? null
        : new ContentListResponseContent.fromJson(jsonRes['content']);
  }
...
class ContentListResponseContent {
  ...
  ContentListResponseContent.fromJson(jsonRes) {
    ...
    collection_flag = jsonRes['collection_flag'] == null ? false : true;
    like_flag = jsonRes['like_flag'] == null ? false : true;
